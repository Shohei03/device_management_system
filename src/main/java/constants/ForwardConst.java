...
public enum ForwardConst {
    ...
    FW_SEARCH_INDEX_BY_EXAM_ITEM("searches/searchByExamItem"),
    FW_SEARCH_INDEX_BY_PAT_ID("searches/searchByPatientId"),
    FW_SEARCH_SHOW("searches/show"),
    FW_REGI_TOP_INDEX("regiTopPage/index"),
    ...
    FW_PACK_CSV_CHECK("packageInserts/csvCheck"),
    ...
    FW_PATDEV_CSV_CHECK("patientDevices/csvCheck"),
    ...
    FW_PATEXAM_CSV_CHECK("patientExaminations/csvCheck"),
