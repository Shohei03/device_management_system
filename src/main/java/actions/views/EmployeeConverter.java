        ...
        return new Employee(
                ...
                ev.getAdminFlag() == null
                        ...
                        : ev.getAdminFlag() == AttributeConst.ROLE_ADMIN.getIntegerValue()
                                ? JpaConst.ROLE_ADMIN
                                : ev.getAdminFlag() == AttributeConst.ROLE_PARTIAL_ADMIN.getIntegerValue()
                                        ? JpaConst.ROLE_PARTIAL_ADMIN
        ...
        return new EmployeeView(
                ...
                e.getAdminFlag() == null
                        ...
                        : e.getAdminFlag() == JpaConst.ROLE_ADMIN
                                ...
                                : e.getAdminFlag() == JpaConst.ROLE_PARTIAL_ADMIN
                                        ? AttributeConst.ROLE_PARTIAL_ADMIN.getIntegerValue()
