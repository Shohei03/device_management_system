...
CREATE TABLE `packageinserts` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_m7ligpfn29gfgy870jejf15l2` (`approvalNumber`),
  UNIQUE KEY `UK_2ly9gq6vx64ys6b1kvxl49e5o` (`deviceName`),
  UNIQUE KEY `UK_2tlcpuvraymlkss646h0ukx5i` (`approvalNumber`),
  UNIQUE KEY `UK_p5rqpdylx14obss51h7edasys` (`deviceName`),
...
-- Dump completed on 2022-11-27 16:30:10
